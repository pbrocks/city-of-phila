jQuery(document).ready(function($) {
	let this_filename = 'phila-code-sample.js';
	$("#phila-code-sample-page").click(function(e) {
		alert('phila-code-sample.js');
		e.preventDefault();
		...
		$.ajax({
			...
			success:function(data) {
				$( '#return-phila-code-sample' ).html(data);
				console.log(data);
			},
			error: function(jqXHR, textStatus, errorThrown){
				$( '#return-phila-code-sample' ).html(errorThrown);
